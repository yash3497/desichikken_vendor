...
class RecievedOrdersScreen extends StatefulWidget {
  ...
  const RecievedOrdersScreen({Key? key}) : super(key: key);

  @override
  State<RecievedOrdersScreen> createState() => _RecievedOrdersScreenState();
}
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              //   width: 79,
              // ),
              Text("Received", style: bodyText20w700(color: black)),
              Icon(
                Icons.search,
                color: primary,
              ),
