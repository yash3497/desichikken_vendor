...
class CancelledorderScrn extends StatefulWidget {
  static String routeName = '/CancelledorderScrn';
  const CancelledorderScrn({Key? key}) : super(key: key);

  @override
  State<CancelledorderScrn> createState() => _CancelledorderScrnState();
}

class _CancelledorderScrnState extends State<CancelledorderScrn> {
  bool isOpen = false;
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              //   width: 79,
              // ),
              Text("Cancelled", style: bodyText20w700(color: black)),
              Icon(
                Icons.search,
                color: primary,
              ),
